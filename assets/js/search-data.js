...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          title: '🌐 On-demand webinar: All you Need to Know About Round Cell Tumor Cytology(VETgirl)....',
          description: "",
          ...
          description: "",
          section: "News",},{id: "news-article-dr-chu-has-published-banish-the-pdf-hunting-blues-with-these-ai-and-digital-tools-on-nature-career-column",
